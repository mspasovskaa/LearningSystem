...
public class MakeupController {
    ...
    public String getCourse(@PathVariable Long id,Model model,HttpServletRequest request)
    {
        ...
        List<QuizScore> quizScores=this.quizScoreService.findAll();
                           ...
                           Model model,HttpServletRequest request)
    {
       ...
       int i=0;
        ...
        int mistake=Math.abs(trueQuestions.size()-questions.size());
        double sum=100-(100.0/questions.size())*mistake;
